...
public class Library {
    ...
    public final int numSections, shelfBookCapacity;
    public final ArrayList<Borrower> users = new ArrayList<Borrower>();

    public Library(int numSections, int shelfBookCapacity, double penalty) {
    ...
    public void addBook(Book book, boolean returnBook) throws NameNotFoundException, SizeLimitExceededException {
    ...
    public void addBorrower(String name, String address, int userID, LibraryCard libraryCard) {
