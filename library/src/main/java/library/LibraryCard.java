...
public class LibraryCard {
    public final int userID, libraryCardID;
    public final String issueDate;
    public final ArrayList<LibraryCardRecord> records = new ArrayList<LibraryCardRecord>();
    ...
    public LibraryCard(int userID, int libraryCardID, String issueDate) {
        this.userID = userID;
